...
val styleString = """
  ...
  "sources": {
    ...
    "maptiler_planet_v4": {
      "url": "https://api.maptiler.com/tiles/v4/tiles.json?key=GCqxEKWuBP1S6iQ1aSBG",
      "type": "vector"
    }
  },
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        "fill-color": "hsla(60, 100%, 90%, 0.45)"
      },
      "filter": [
        "==",
        [
    ...
    {
      "id": "Road under construction outline",
      "type": "line",
      "source": "maptiler_planet_v4",
      "source-layer": "road",
      "minzoom": 4,
    ...
    {
      "id": "Road bridge outline (under construction)",
      "type": "line",
      "source": "maptiler_planet_v4",
      "source-layer": "road",
      "minzoom": 8,
    ...
    {
      "id": "Road bridge (under construction)",
      "type": "line",
      "source": "maptiler_planet_v4",
      "source-layer": "road",
      "minzoom": 8,
    ...
    },
    {
      ...
      "paint": {
        ...
        "icon-halo-width": 1,
        "text-color": "hsl(205, 84%, 40%)",
        "text-halo-blur": 1,
        "text-halo-color": "hsl(206, 85%, 92%)",
        "text-halo-width": [
          "interpolate",
          [
            "exponential",
    ...
    },
    {
      ...
      "paint": {
        ...
        "text-color": "hsl(205, 84%, 40%)",
        "text-halo-blur": 1.2,
        "text-halo-color": "hsla(206, 100%, 92%, 0.5)",
        "text-halo-width": 1.6
      },
      "filter": [
        "all",
    ...
    },
    {
      ...
      "paint": {
        "text-color": "hsl(25, 7%, 34%)",
        "text-halo-blur": 0.2,
        "text-halo-color": "hsl(49, 82%, 95%)",
        "text-halo-width": 1
      },
      "filter": [
        "==",
    ...
    },
    {
      ...
      "paint": {
        "icon-color": "hsl(0, 0%, 93%)",
        "icon-halo-color": "hsl(0, 0%, 53%)",
        "icon-halo-width": 1,
    ...
    {
      "id": "Highway shields bicolor top",
      "type": "symbol",
      "source": "maptiler_planet_v4",
      "source-layer": "road_label",
      "minzoom": 7,
    ...
    },
    {
      ...
      "paint": {
        "icon-color": "hsl(103, 40%, 70%)",
        "icon-halo-color": "rgba(255, 255, 255, 1)",
        "icon-halo-width": 1,
        "icon-opacity": 1,
        "text-color": "hsl(103, 40%, 70%)",
        "text-halo-color": "rgba(255, 255, 255, 1)",
        "text-halo-width": 1,
        "text-opacity": 1
      },
    ...
    },
    {
      ...
      "paint": {
        "icon-color": "hsl(103, 40%, 60%)",
        "icon-halo-blur": 1,
        "icon-halo-color": "hsla(0, 0%, 100%, 0.8)",
        "icon-halo-width": 2,
        "text-color": "hsl(103, 40%, 60%)",
        "text-halo-blur": 1,
    ...
    },
    {
      ...
      "paint": {
        "text-color": "hsl(0,0%,25%)",
        "text-halo-color": "hsl(176, 100%, 92%)",
        "text-halo-width": 1.2,
        "text-opacity": 1
      },
      "filter": [
      ...
      "groups": [
        ...
        },
        {
          ...
          "layers": [
            ...
            "Road under construction outline",
            "Road bridge",
            "Road bridge outline",
            "Road bridge (under construction)",
            "Road bridge outline (under construction)",
            "Road tunnel",
            "Road tunnel outline",
            "Cycleway bridge",
            "Cycleway tunnel",
            "Cycleway bridge outline",
            "Cycleway tunnel outline"
          ],
          "name": "Roads"
        },
        {
  ...
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=GCqxEKWuBP1S6iQ1aSBG",
