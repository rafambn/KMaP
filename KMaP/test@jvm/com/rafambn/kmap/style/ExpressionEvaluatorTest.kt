...
val ExpressionEvaluatorTest by testSuite {
    testFixture { ExpressionEvaluator() } asParameterForEach {
        test("testAll") { evaluator ->
        ...
        test("testInterpolateLinear") { evaluator ->
            val context = EvaluationContext(zoomLevel = 7.5)
        ...
        test("testInterpolateExponential") { evaluator ->
            val context = EvaluationContext(zoomLevel = 7.5)
        ...
        test("testEdgeCaseNullProperties") { evaluator ->
        ...
        test("testEdgeCaseMissingProperties") { evaluator ->
        ...
        test("testEdgeCaseEmptyArrays") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseBoundaryValues") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseNullComparison") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseCoercion") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseDeepNesting") { evaluator ->
        ...
        test("testEdgeCaseStringOperations") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseMathOperations") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseColorOperations") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseArrayMembership") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testEdgeCaseMatchExpression") { evaluator ->
            val context = EvaluationContext()
        ...
        test("testFilterRestrictionIntegerZoom") { evaluator ->
        ...
        test("testGetPropertyWithSpecialCharacters") { evaluator ->
        ...
        test("testInterpolateWithAllModes") { evaluator ->
            val context = EvaluationContext(zoomLevel = 7.5)
