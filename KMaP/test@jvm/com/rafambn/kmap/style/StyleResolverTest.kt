...
val StyleResolverTest by testSuite {
    testFixture { Json { ignoreUnknownKeys = true } } asParameterForEach {
        test("testResolveSimpleStyle") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testResolveColorString") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testLineLayerWithExpressions") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testBackgroundLayerWithExpressions") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testSymbolLayerWithTextField") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testSymbolLayerWithIconSize") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testFillLayerWithFilter") { json ->
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
