...
val RealWorldStyleIntegrationTest by testSuite {
    testFixture {
        ...
        test("testStyle1AquarelleLoading") {
        ...
        test("testMultipleStylesEvaluateCorrectly") {
        ...
        test("testStylesWithInterpolationExpressions") {
        ...
        test("testMultipleLayerTypesInSingleStyle") {
            val style = loadStyleFile("style1.json") ?: run {
        ...
        test("testStyleWithComplexExpressions") {
            val style = loadStyleFile("style1.json") ?: run {
