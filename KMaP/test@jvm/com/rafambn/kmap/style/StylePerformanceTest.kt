 ...
 */
val StylePerformanceTest by testSuite {
    testFixture {
        object {
        ...
        test("testCompilationTimeSimpleStyle") {
            val rawStyleJson = """
                {
                    "version": 8,
                    "name": "Test Style",
        ...
        test("testCompilationTimeComplexStyle") {
        ...
        test("testEvaluationTimePerProperty") {
        ...
        test("testBatchEvaluationPerformance") {
            val rawStyleJson = """
                {
                    "version": 8,
        ...
        test("testCompilationVsEvaluationRatio") {
            val style = loadStyleFile("style1.json")
            if (style == null) {
        ...
        test("testMultipleStyleCompilation") {
        ...
        test("testCubicBezierInterpolationPerformance") {
