...
val ReferenceTest by testSuite {
    test("mapReferencesRejectNonFiniteValues") {
    ...
    test("arithmeticPreservesTheReferenceType") {
    ...
    test("differentReferenceTypesAreNotEqual") {
    ...
    test("typedTransformationsReturnTheInputType") {
